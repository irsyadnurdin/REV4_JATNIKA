                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <a href="<?php echo base_url('pendataan/logout') ?>" class="btn btn-primary btn-block"><b>Log Out</b></a>
                        </div>
                    </div>
...
<?= $this->section('javascript') ?>
    ...
    <script type="text/javascript">
        $('.edit_pengguna').submit(function(e){
            ...
            $.ajax({
                type: "post",
                url: "<?=base_url('pendataan/edit_profile')?>",
                ...
                success: function (data) {
                    if (data == "sukses") {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                window.location.assign('<?=base_url('pendataan/profile')?>');
                            }
                        }) 
                    }   
                },
        ...
        $('.edit_password').submit(function(e){
            ...
            if (password != password_ulang) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?=base_url('pendataan/edit_password_pengguna')?>",
                    data: new FormData(this),
                    processData:false,
                    contentType:false,
                    cache:false,
