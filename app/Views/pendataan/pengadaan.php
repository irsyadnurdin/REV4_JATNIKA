    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('pendataan/pengadaan') ?>">Lihat Data</a></li>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="tab_0">
                                <?= view_cell('\App\Libraries\Widget::pengadaan', ['id_tabel' => 'pengadaan_0', 'status' => 0, 'tambah' => false]) ?>
                            </div>

                            <div class="tab-pane" id="tab_1">
                                <?= view_cell('\App\Libraries\Widget::pengadaan', ['id_tabel' => 'pengadaan_1', 'status' => 1, 'tambah' => false]) ?>
                            </div>

                            <div class="wtf tab-pane" id="tab_2">
                                <?= view_cell('\App\Libraries\Widget::pengadaan', ['id_tabel' => 'pengadaan_2', 'status' => 2, 'tambah' => false]) ?>
                            </div>
...
<?= $this->section('javascript') ?>
    ...
    <script>
        $('.detail_pengadaan').on('click', function (e) {
            ...
            $.ajax({
                type : 'POST',
                url : '<?=base_url('pendataan/get_detail_pengadaan')?>',
                dataType:'json',
                data: {
                ...
                error: function() {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.assign('<?=base_url('pendataan/pengadaan')?>');
                        }
                    }) 
                }	
            });
